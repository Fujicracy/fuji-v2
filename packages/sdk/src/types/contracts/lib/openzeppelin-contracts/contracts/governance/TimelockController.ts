...
export interface TimelockControllerMulticall {
  address: string;
  abi: Fragment[];
  functions: FunctionFragment[];

  CANCELLER_ROLE(overrides?: CallOverrides): Call<string>;

  DEFAULT_ADMIN_ROLE(overrides?: CallOverrides): Call<string>;

  EXECUTOR_ROLE(overrides?: CallOverrides): Call<string>;

  PROPOSER_ROLE(overrides?: CallOverrides): Call<string>;

  TIMELOCK_ADMIN_ROLE(overrides?: CallOverrides): Call<string>;

  getMinDelay(overrides?: CallOverrides): Call<BigNumber>;

  getRoleAdmin(role: BytesLike, overrides?: CallOverrides): Call<string>;

  getTimestamp(id: BytesLike, overrides?: CallOverrides): Call<BigNumber>;
  ...
  isOperation(id: BytesLike, overrides?: CallOverrides): Call<boolean>;

  isOperationDone(id: BytesLike, overrides?: CallOverrides): Call<boolean>;

  isOperationPending(id: BytesLike, overrides?: CallOverrides): Call<boolean>;

  isOperationReady(id: BytesLike, overrides?: CallOverrides): Call<boolean>;
