...
import type {
  ...
  ICTokenInterface,
  ICTokenMulticall,
} from "../../../../src/interfaces/compoundV2/ICToken";
...
export class ICToken__factory {
  ...
  static multicall(address: string): ICTokenMulticall {
    return new MulticallContract(address, _abi) as unknown as ICTokenMulticall;
  }
}
