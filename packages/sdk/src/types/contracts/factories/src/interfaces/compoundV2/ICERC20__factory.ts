...
import type {
  ...
  ICERC20Interface,
  ICERC20Multicall,
} from "../../../../src/interfaces/compoundV2/ICERC20";
...
export class ICERC20__factory {
  ...
  static multicall(address: string): ICERC20Multicall {
    return new MulticallContract(address, _abi) as unknown as ICERC20Multicall;
  }
}
