...
import type {
  ...
  YieldVaultInterface,
  YieldVaultMulticall,
} from "../../../../src/vaults/yields/YieldVault";
...
const _abi = [
  ...
  {
    inputs: [],
    name: "YieldVault__notApplicable",
    type: "error",
  },
  {
    inputs: [],
    name: "YieldVault__rebalance_invalidProvider",
    type: "error",
  },
  {
    anonymous: false,
...
export class YieldVault__factory {
  static readonly abi = _abi;
  static createInterface(): YieldVaultInterface {
    return new utils.Interface(_abi) as YieldVaultInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): YieldVault {
    return new Contract(address, _abi, signerOrProvider) as YieldVault;
  }
  static multicall(address: string): YieldVaultMulticall {
    return new MulticallContract(
      address,
      _abi
    ) as unknown as YieldVaultMulticall;
  }
}
