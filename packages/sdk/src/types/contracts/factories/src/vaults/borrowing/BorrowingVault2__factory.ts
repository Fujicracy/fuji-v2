...
import type {
  BorrowingVault2,
  BorrowingVault2Interface,
  BorrowingVault2Multicall,
} from "../../../../src/vaults/borrowing/BorrowingVault2";
...
const _abi = [
  ...
  {
    inputs: [],
    name: "BaseVault__deposit_invalidInput",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "BaseVault__initializeVaultShares_alreadyInitialized",
    type: "error",
  },
  {
    inputs: [],
    name: "BaseVault__initializeVaultShares_lessThanMin",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "BorrowingVault__beforeTokenTransfer_moreThanMax",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "BorrowingVault__borrow_slippageTooHigh",
    type: "error",
  },
  {
    inputs: [],
    name: "BorrowingVault__burnDebtShares_amountExceedsBalance",
    type: "error",
  },
  {
    inputs: [],
    name: "BorrowingVault__burnDebt_slippageTooHigh",
    type: "error",
  },
  {
    inputs: [],
    name: "BorrowingVault__correctDebt_noNeedForCorrection",
    type: "error",
  },
  {
    inputs: [],
    name: "BorrowingVault__initializeVaultShares_assetDebtRatioExceedsMaxLtv",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "BorrowingVault__mintDebt_slippageTooHigh",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "BorrowingVault__payback_slippageTooHigh",
    type: "error",
  },
  {
    inputs: [],
...
export class BorrowingVault2__factory {
  static readonly abi = _abi;
  static createInterface(): BorrowingVault2Interface {
    return new utils.Interface(_abi) as BorrowingVault2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BorrowingVault2 {
    return new Contract(address, _abi, signerOrProvider) as BorrowingVault2;
  }
  static multicall(address: string): BorrowingVault2Multicall {
    return new MulticallContract(
      address,
      _abi
    ) as unknown as BorrowingVault2Multicall;
  }
}
