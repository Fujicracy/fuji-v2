...
import type {
  ...
  MorphoCompoundMulticall,
} from "../../../../src/providers/mainnet/MorphoCompound";
...
export class MorphoCompound__factory {
  ...
  static multicall(address: string): MorphoCompoundMulticall {
    return new MulticallContract(
      address,
      _abi
    ) as unknown as MorphoCompoundMulticall;
  }
}
