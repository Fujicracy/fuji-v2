...
import type {
  ...
  AccessControlMulticall,
} from "../../../../../lib/openzeppelin-contracts/contracts/access/AccessControl";
...
export class AccessControl__factory {
  ...
  static multicall(address: string): AccessControlMulticall {
    return new MulticallContract(
      address,
      _abi
    ) as unknown as AccessControlMulticall;
  }
}
