...
import type {
  ...
  IAccessControlMulticall,
} from "../../../../../lib/openzeppelin-contracts/contracts/access/IAccessControl";
...
export class IAccessControl__factory {
  ...
  static multicall(address: string): IAccessControlMulticall {
    return new MulticallContract(
      address,
      _abi
    ) as unknown as IAccessControlMulticall;
  }
}
