...
export class TimelockController__factory {
  ...
  static multicall(address: string): TimelockControllerMulticall {
    return new MulticallContract(
      address,
      _abi
    ) as unknown as TimelockControllerMulticall;
  }
}
