...
export interface IGenITokenInterface extends utils.Interface {
  functions: {
...
export interface IGenIToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IGenITokenInterface;
...
export interface IGenITokenMulticall {
  address: string;
  abi: Fragment[];
