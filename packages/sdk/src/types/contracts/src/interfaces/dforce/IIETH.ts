...
export interface IIETHInterface extends utils.Interface {
  functions: {
    ...
    "mintForSelfAndEnterMarket()": FunctionFragment;
...
export interface IIETH extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IIETHInterface;
  ...
  callStatic: {
    ...
    mintForSelfAndEnterMarket(overrides?: CallOverrides): Promise<void>;
...
export interface IIETHMulticall {
  address: string;
  abi: Fragment[];
