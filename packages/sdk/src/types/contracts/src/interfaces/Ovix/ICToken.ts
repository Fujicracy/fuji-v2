...
export interface ICTokenMulticall {
  address: string;
  abi: Fragment[];
  functions: FunctionFragment[];

  accrualBlockTimestamp(overrides?: CallOverrides): Call<BigNumber>;
  ...
  borrowRatePerTimestamp(overrides?: CallOverrides): Call<BigNumber>;
  ...
  supplyRatePerTimestamp(overrides?: CallOverrides): Call<BigNumber>;
