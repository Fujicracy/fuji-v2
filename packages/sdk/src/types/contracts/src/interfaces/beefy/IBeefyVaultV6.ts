...
export interface IBeefyVaultV6Interface extends utils.Interface {
  functions: {
...
export interface IBeefyVaultV6 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IBeefyVaultV6Interface;
...
export interface IBeefyVaultV6Multicall {
  address: string;
  abi: Fragment[];
  ...
  getPricePerFullShare(overrides?: CallOverrides): Call<BigNumber>;

  totalSupply(overrides?: CallOverrides): Call<BigNumber>;

  want(overrides?: CallOverrides): Call<string>;
}
