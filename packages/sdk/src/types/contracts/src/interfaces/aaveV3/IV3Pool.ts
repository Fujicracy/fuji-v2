...
export declare namespace IV3Pool {
  ...
  export type ReserveDataStruct = {
    configuration: IV3Pool.ReserveConfigurationMapStruct;
  ...
  export type ReserveDataStructOutput = [
    IV3Pool.ReserveConfigurationMapStructOutput,
    BigNumber,
    BigNumber,
    BigNumber,
    BigNumber,
    ...
    configuration: IV3Pool.ReserveConfigurationMapStructOutput;
...
export interface IV3Pool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IV3PoolInterface;
  ...
  functions: {
    ...
    ): Promise<[IV3Pool.ReserveDataStructOutput]>;
...
export interface IV3PoolMulticall {
  address: string;
  abi: Fragment[];
  ...
  getReserveData(
    asset: string,
    overrides?: CallOverrides
  ): Call<IV3Pool.ReserveDataStructOutput>;
}
