...
export interface DForcePolygonInterface extends utils.Interface {
  functions: {
...
export interface DForcePolygon extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DForcePolygonInterface;
...
export interface DForcePolygonMulticall {
  address: string;
  abi: Fragment[];
