...
export interface AaveV3PolygonInterface extends utils.Interface {
  functions: {
...
export interface AaveV3Polygon extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AaveV3PolygonInterface;
...
export interface AaveV3PolygonMulticall {
  address: string;
  abi: Fragment[];
