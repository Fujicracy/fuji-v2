...
export interface OvixPolygonInterface extends utils.Interface {
  functions: {
...
export interface OvixPolygon extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OvixPolygonInterface;
...
export interface OvixPolygonMulticall {
  address: string;
  abi: Fragment[];
