...
export interface WePiggyPolygonInterface extends utils.Interface {
  functions: {
...
export interface WePiggyPolygon extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WePiggyPolygonInterface;
...
export interface WePiggyPolygonMulticall {
  address: string;
  abi: Fragment[];
