...
export interface CompoundV3PolygonInterface extends utils.Interface {
  functions: {
...
export interface CompoundV3Polygon extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CompoundV3PolygonInterface;
...
export interface CompoundV3PolygonMulticall {
  address: string;
  abi: Fragment[];
