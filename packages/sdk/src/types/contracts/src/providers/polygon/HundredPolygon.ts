...
export interface HundredPolygonInterface extends utils.Interface {
  functions: {
...
export interface HundredPolygon extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HundredPolygonInterface;
...
export interface HundredPolygonMulticall {
  address: string;
  abi: Fragment[];
