...
export interface CompoundV3ArbitrumInterface extends utils.Interface {
  functions: {
...
export interface CompoundV3Arbitrum extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CompoundV3ArbitrumInterface;
...
export interface CompoundV3ArbitrumMulticall {
  address: string;
  abi: Fragment[];
