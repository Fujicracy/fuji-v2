...
export interface HundredArbitrumInterface extends utils.Interface {
  functions: {
...
export interface HundredArbitrum extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HundredArbitrumInterface;
...
export interface HundredArbitrumMulticall {
  address: string;
  abi: Fragment[];
