...
export interface AaveV3ArbitrumInterface extends utils.Interface {
  functions: {
...
export interface AaveV3Arbitrum extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AaveV3ArbitrumInterface;
...
export interface AaveV3ArbitrumMulticall {
  address: string;
  abi: Fragment[];
