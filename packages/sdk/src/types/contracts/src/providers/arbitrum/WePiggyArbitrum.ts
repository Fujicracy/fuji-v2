...
export interface WePiggyArbitrumInterface extends utils.Interface {
  functions: {
...
export interface WePiggyArbitrum extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WePiggyArbitrumInterface;
...
export interface WePiggyArbitrumMulticall {
  address: string;
  abi: Fragment[];
