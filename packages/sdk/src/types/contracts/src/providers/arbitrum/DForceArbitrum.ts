...
export interface DForceArbitrumInterface extends utils.Interface {
  functions: {
...
export interface DForceArbitrum extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DForceArbitrumInterface;
...
export interface DForceArbitrumMulticall {
  address: string;
  abi: Fragment[];
