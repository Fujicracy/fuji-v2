...
export interface RadiantArbitrumInterface extends utils.Interface {
  functions: {
...
export interface RadiantArbitrum extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RadiantArbitrumInterface;
...
export interface RadiantArbitrumMulticall {
  address: string;
  abi: Fragment[];
