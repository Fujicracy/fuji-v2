...
export interface IronBankOptimismInterface extends utils.Interface {
  functions: {
...
export interface IronBankOptimism extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IronBankOptimismInterface;
...
export interface IronBankOptimismMulticall {
  address: string;
  abi: Fragment[];
