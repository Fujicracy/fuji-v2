...
export interface BeefyVelodromesETHETHOptimismInterface
...
export interface BeefyVelodromesETHETHOptimism extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BeefyVelodromesETHETHOptimismInterface;
...
export interface BeefyVelodromesETHETHOptimismMulticall {
  address: string;
  abi: Fragment[];
