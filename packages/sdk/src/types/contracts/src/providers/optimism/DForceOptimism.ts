...
export interface DForceOptimismInterface extends utils.Interface {
  functions: {
...
export interface DForceOptimism extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DForceOptimismInterface;
...
export interface DForceOptimismMulticall {
  address: string;
  abi: Fragment[];
