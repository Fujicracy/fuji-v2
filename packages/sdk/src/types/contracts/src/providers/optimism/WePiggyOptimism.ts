...
export interface WePiggyOptimismInterface extends utils.Interface {
  functions: {
...
export interface WePiggyOptimism extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WePiggyOptimismInterface;
...
export interface WePiggyOptimismMulticall {
  address: string;
  abi: Fragment[];
