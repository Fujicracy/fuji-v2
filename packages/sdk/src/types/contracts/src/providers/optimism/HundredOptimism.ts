...
export interface HundredOptimismInterface extends utils.Interface {
  functions: {
...
export interface HundredOptimism extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HundredOptimismInterface;
...
export interface HundredOptimismMulticall {
  address: string;
  abi: Fragment[];
