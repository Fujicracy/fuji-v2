...
export interface AaveV3OptimismInterface extends utils.Interface {
  functions: {
...
export interface AaveV3Optimism extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AaveV3OptimismInterface;
...
export interface AaveV3OptimismMulticall {
  address: string;
  abi: Fragment[];
