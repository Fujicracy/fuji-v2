...
export interface HundredGnosisInterface extends utils.Interface {
  functions: {
...
export interface HundredGnosis extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HundredGnosisInterface;
...
export interface HundredGnosisMulticall {
  address: string;
  abi: Fragment[];
