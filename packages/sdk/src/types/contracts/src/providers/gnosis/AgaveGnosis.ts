...
export interface AgaveGnosisInterface extends utils.Interface {
  functions: {
...
export interface AgaveGnosis extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AgaveGnosisInterface;
...
export interface AgaveGnosisMulticall {
  address: string;
  abi: Fragment[];
