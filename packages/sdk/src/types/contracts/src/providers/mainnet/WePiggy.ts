...
export interface WePiggyInterface extends utils.Interface {
  functions: {
...
export interface WePiggy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WePiggyInterface;
...
export interface WePiggyMulticall {
  address: string;
  abi: Fragment[];
