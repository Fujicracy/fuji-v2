...
export interface CompoundV2GoerliInterface extends utils.Interface {
  functions: {
    ...
    "getBorrowBalanceTest_1(address,address)": FunctionFragment;
    "getBorrowBalanceTest_2(address,address)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "deposit"
      | "getBorrowBalance"
      | "getBorrowBalanceTest_1"
      | "getBorrowBalanceTest_2"
      | "getBorrowRateFor"
      | "getDepositBalance"
      | "getDepositRateFor"
      | "getMapper"
  ...
  encodeFunctionData(
    functionFragment: "getBorrowBalanceTest_1",
    values: [string, string]
  ): string;
  encodeFunctionData(
    functionFragment: "getBorrowBalanceTest_2",
    values: [string, string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "getMapper", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "getMapper", data: BytesLike): Result;
...
export interface CompoundV2Goerli extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CompoundV2GoerliInterface;
  ...
  functions: {
    ...
    getMapper(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    getMapper(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getMapper(overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
export interface CompoundV2GoerliMulticall {
  address: string;
  abi: Fragment[];
  ...
  getMapper(overrides?: CallOverrides): Call<string>;
