...
export interface MockProviderV0Interface extends utils.Interface {
  functions: {
...
export interface MockProviderV0 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockProviderV0Interface;
...
export interface MockProviderV0Multicall {
  address: string;
  abi: Fragment[];
