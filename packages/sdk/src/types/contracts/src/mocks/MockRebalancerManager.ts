...
export interface MockRebalancerManagerInterface extends utils.Interface {
  functions: {
...
export interface MockRebalancerManager extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockRebalancerManagerInterface;
...
export interface MockRebalancerManagerMulticall {
  address: string;
  abi: Fragment[];
