...
export interface YieldVaultInterface extends utils.Interface {
  functions: {
...
export interface YieldVault extends BaseContract {
  ...
  functions: {
    ...
    maxBorrow(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;

    maxBurnDebt(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    maxMintDebt(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;

    maxPayback(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  balanceOfDebt(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  getHealthFactor(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
...
export interface YieldVaultMulticall {
  address: string;
  abi: Fragment[];
  ...
  balanceOfDebt(arg0: string, overrides?: CallOverrides): Call<BigNumber>;
  ...
  convertToDebt(arg0: BigNumberish, overrides?: CallOverrides): Call<BigNumber>;
  ...
  getHealthFactor(arg0: string, overrides?: CallOverrides): Call<BigNumber>;
  ...
  maxBorrow(arg0: string, overrides?: CallOverrides): Call<BigNumber>;

  maxBurnDebt(arg0: string, overrides?: CallOverrides): Call<BigNumber>;

  maxDeposit(arg0: string, overrides?: CallOverrides): Call<BigNumber>;

  maxMint(arg0: string, overrides?: CallOverrides): Call<BigNumber>;

  maxMintDebt(arg0: string, overrides?: CallOverrides): Call<BigNumber>;

  maxPayback(arg0: string, overrides?: CallOverrides): Call<BigNumber>;
  ...
  previewBorrow(arg0: BigNumberish, overrides?: CallOverrides): Call<BigNumber>;
