...
export interface BorrowingVault2Interface extends utils.Interface {
  functions: {
    ...
    "setLtvFactors(uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setLtvFactors",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface BorrowingVault2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BorrowingVault2Interface;
...
export interface BorrowingVault2Multicall {
  address: string;
  abi: Fragment[];
