...
export interface BorrowingVaultFactory2Interface extends utils.Interface {
  functions: {
    ...
    "getContractCode()": FunctionFragment;
...
export interface BorrowingVaultFactory2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BorrowingVaultFactory2Interface;
  ...
  getContractCode(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
    ...
    getContractCode(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getContractCode(overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
export interface BorrowingVaultFactory2Multicall {
  address: string;
  abi: Fragment[];
  ...
  getContractCode(overrides?: CallOverrides): Call<string>;
