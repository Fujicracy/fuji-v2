...
export interface PausableVaultInterface extends utils.Interface {
  functions: {
...
export interface PausableVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PausableVaultInterface;
...
export interface PausableVaultMulticall {
  address: string;
  abi: Fragment[];
