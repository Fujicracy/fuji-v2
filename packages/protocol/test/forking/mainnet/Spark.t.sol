...
contract SparkForkingTests is Routines, ForkingSetup {
  ILendingProvider public spark;
  ...
  function setUp() public {
    ...
    debtAsset = registry[MAINNET_DOMAIN].dai;
  ...
  function test_getInterestRates() public {
    uint256 depositRate = spark.getDepositRateFor(vault);
